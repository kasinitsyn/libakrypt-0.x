...
/*! \brief Тестирование корректной работы алгоритма блочного шифрования AES-128 (FIPS 197). */
 dll_export bool_t ak_libakrypt_test_aes128( void );
...
/*! \brief Инициализация секретного ключа алгоритма блочного шифрования AES-128. */
 dll_export int ak_bckey_create_aes128( ak_bckey );
